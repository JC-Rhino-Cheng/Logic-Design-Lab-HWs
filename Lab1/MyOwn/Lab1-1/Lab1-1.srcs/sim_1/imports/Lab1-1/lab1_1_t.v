...
module lab1_1_t;
  ...
  initial begin
    ...
    {a, b, c, sub} = 4'd0;  // a, b, c, and sub signals are all set to 0.
  ...
  task test; 
    begin
      ...
      if ((sub == 1 && {e,d} !== a + !b + c) || (/* add condition here when sub == 0 */ sub == 0 && {e,d} !== a + b + c)) begin
        printerror;
      end
    end
  endtask
  ...
  task printerror;
    begin
      ...
      pass = /* add code here */ 1'b0;
      $display($time," Error:  a = %b, b = %b, c = %b, d = %b, e = %b, sub = %b",
        /* add code here */a, b, c, d, e, sub);
    end
  endtask
endmodule
